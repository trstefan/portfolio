  ...
  return (
    <div className="about">
      ...
      <p className={styles.about__paragraphs}>
        ...
        things that live on the internet. I’m a junior frontend developer (with
        a small experience in backend development) looking for a new role in an
        exciting company. I focus on writing accessible HTML, using modern CSS
        practices and writing clean JavaScript. When writing JavaScript code, I
        mostly use React, but I can adapt to whatever tools are required. My
        interest in web development started back in high school when I had to
        build my first website using HTML & CSS.
      </p>
      <br />
      <p className={styles.about__paragraphs}>
      ...
      <p className={styles.about__paragraphs}>
        ...
        React. Also, I'm trying to become a more active open source contributor,
        learn new technologies like Next.js and Tailwind CSS and write cleaner
        and more accesible lines of code.
      </p>
      <Link href="/stack">
